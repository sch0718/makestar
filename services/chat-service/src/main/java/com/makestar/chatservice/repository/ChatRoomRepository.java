...
import com.makestar.chatservice.model.ChatRoom.ChatRoomType;
...
public interface ChatRoomRepository extends JpaRepository<ChatRoom, String> {
     ...
     */
    @Query("SELECT r FROM ChatRoom r WHERE r.type = com.makestar.chatservice.model.ChatRoom$ChatRoomType.DIRECT " +
